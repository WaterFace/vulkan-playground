...
bool vkutil::loadImageFromFile(Engine &engine, const char *file,
  ...
  vmaCreateImage(engine.allocator, &info, &allocInfo, &newImage.image,
  ...
  vmaDestroyBuffer(engine.allocator, stagingBuffer.buffer,
